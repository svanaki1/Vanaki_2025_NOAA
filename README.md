...
Our paper, [*"How many dollars are in the sea?"*](https://doi.org/10.1016/j.ecoinf.2025.103311), published in *Ecological Informatics*, describes an iterative process combining machine learning and human expertise to count sand dollars in underwater images. This repo shares our initial model outputs and a labeling app used to train a more accurate second model. 
---
...
├── gam/ # code and [large dataset](https://drive.google.com/file/d/1ZnHc_lDQ8XsQk4ycLWJxplU-ZHZQ2elW/view?usp=sharing) used for the CNN
